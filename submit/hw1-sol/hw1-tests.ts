...
const FN_TESTS = [
  ...
  },
  {
    ...
    tests: [
      ...
      { args: ["Twas brillig and the slithy toves", 5], result: ["toves"] },
      { args: ["Twas brillig and the slithy toves", 8], result: [] },
      { args: ["  "], result: [] },
    ],
  },
  {
  ...
  },
  {
    fn: FNS.wordLenPoly,
    tests: [
      { args: ["a a a a", 2], result: 15 },
      { args: ["a aa aaa aaaa", 10], result: 4321 },
      { args: ["@ @@ @@@ @", 10], result: 1321 },
      { args: [" @@ ", 10], result: 2 },
      { args: [" ", 10], result: 0 },
    ],
  },
  {
    fn: FNS.map2,
    tests: [
      { args: [(a, b) => a + b, [1, 2, 3], [3, 4, 5]], result: [4, 6, 8] },
      { args: [(a, b) => a + b, [1, 2], [3, 4, 5]], result: [4, 6] },
      { args: [(a, b) => a + b, [1], [3, 4, 5]], result: [4] },
      {
        args: [(a, b) => a * b.length, [1, 2, 3], ["twas", "brillig", "and"]],
        result: [4, 14, 9],
      },
      { args: [(a, b) => a + b, [], [3, 4, 5]], result: [] },
      { args: [(a, b) => a * b, [1, 2], [3, 4, 5]], result: [3, 8] },
      { args: [(a, b) => a * b, [1, 2], []], result: [] },
      {
  ...
  },
  {
    fn: FNS.rmap2,
    tests: [
      { args: [(a, b) => a * b, [3, 4, 5]], result: [15, 16, 15] },
      {
        args: [(a, b) => a / b, [3, 4, 5]],
        result: [0.6, 1, 1.6666666666666667],
      },
      { args: [(a, b) => a - b, [3, 4, 5]], result: [-2, 0, 2] },
      { args: [(a, b) => a - b, [3, 4, 5, 6]], result: [-3, -1, 1, 3] },
      { args: [(a, b) => a - b, [3]], result: [0] },
      { args: [(a, b) => a * b, [3]], result: [9] },
      { args: [(a, b) => a * b, []], result: [] },
    ],
  },
  {
    fn: FNS.partialSums,
    tests: [
      { args: [[1, 2, 3, 4]], result: [1, 3, 6, 10] },
      { args: [[1, 2, 3, 4, 5, 6, 7]], result: [1, 3, 6, 10, 15, 21, 28] },
      {
        args: [[1, -2, 3, -4, 5, -6, 7, -8, 9]],
        result: [1, -1, 2, -2, 3, -3, 4, -4, 5],
      },
      { args: [[11, 22]], result: [11, 33] },
      { args: [[11]], result: [11] },
      { args: [[]], result: [] },
    ],
  },
  {
    ...
    tests: [
      { args: [(a, b) => a + b, [1, 2, 3, 4]], result: [1, 3, 6, 10] },
      {
      ...
      { args: [(a, b) => a * b, [11, 22]], result: [11, 242] },
      { args: [(a, b) => a + b, [11]], result: [11] },
      { args: [(a, b) => a + b, []], result: [] },
    ],
  },
];
